...
export default function RoomDetailsPage() {
  ...
  const { data: room, isLoading: isLoadingRoom } = useQuery({
    ...
    queryFn: () => roomService.findOne(roomId),
  ...
  const isCreator = room && user && (
    (typeof room.creator === "string" && room.creator === user._id) ||
          ...
          <div className="glass-card rounded-2xl p-6">
            <div className="text-center py-12">
              ...
              <p className="text-white/70 mb-4">
                The room doesn&apos;t exist or you don&apos;t have access to it.
              </p>
        ...
        <div className="glass-card rounded-2xl p-6 mb-6 flex-shrink-0">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              {isCreator && (
                <Link href={routes.editRoom(room._id)}>
                  <Button variant="ghost" className="text-white hover:bg-white/10">
                    ...
                    <>
                      {messages.map((message) => (
                        <MessageBubble 
                          ...
                          roomCreatorId={typeof room?.creator === "string" ? room.creator : room?.creator?._id}
                        />
                      ))}
...
function MessageBubble({ 
  ...
  // Check if message is from room creator
  const isFromCreator = typeof message.from === "string"
    ? message.from === roomCreatorId
    : message.from._id === roomCreatorId;
